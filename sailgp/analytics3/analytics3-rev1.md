...
- Completed the previous SailGP analytics Labs
...
1. Open the Project that we created earlier by clicking on **Projects and Reports** or **Projects** and then click on `Performance analysis`.

   ![pic2](images/open-project2.png)

1. Compare the number of maneuvers
